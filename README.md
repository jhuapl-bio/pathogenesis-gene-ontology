...
Editors of this ontology should use the edit version, [src/ontology/pathgo-edit.owl](src/ontology/pathgo-edit.owl)

## Contact

Please use this GitHub repository's [Issue tracker](https://github.com/rjacak/pathogenesis-gene-ontology/issues) to request new terms/classes or report errors or specific concerns related to the ontology.
