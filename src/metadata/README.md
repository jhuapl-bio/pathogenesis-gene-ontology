 ...
 * [pathgo.yml](pathgo.yml)
     * Determines how your purl.obolibrary.org/obo/pathgo/ redirects will be handled
     ...
     * Paste in the contents of [pathgo.yml](pathgo.yml)
 ...
 * [pathgo.md](pathgo.md)
     ...
     * Paste in the contents of [pathgo.md](pathgo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
